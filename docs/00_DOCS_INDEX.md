...
11. docs/17_GOLDEN_FIXTURES_AND_EXPECTED_OUTPUTS.md, se il pass tocca fixture/demo/hook events
...
| `09_AGENTS_AND_HOOKS_CONTRACT.md` | Micro-agent, subagenti opzionali, hooks | P5, P7, P8 |
...
| `15_STATIC_FILE_TEMPLATES.md` | Template completi per artifact statici P0/P1/P8 | Quando si creano package/plugin/MCP/hook/skill/subagent template |
...
| `17_GOLDEN_FIXTURES_AND_EXPECTED_OUTPUTS.md` | Fixture canonica, DB rows attese, golden CLI/MCP/hook | P3–P9 e validazione finale |
...
5. Non fare hook invasivi o scan pesanti su `UserPromptSubmit`.
...
- micro-agent, hook e subagenti sono separati;
...
6. **Output pubblico sempre validabile.** Ogni CLI/MCP/hook output deve essere confrontabile con esempi e shape presenti nei contratti.
