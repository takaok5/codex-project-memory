...
export async function cmdInit(options: InitOptions): Promise<CliResult<InitOutput>> {
  try {
...
function relToAbs(paths: ReturnType<typeof getMemoryPaths>, rel: string): string {
