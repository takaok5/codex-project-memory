...
export function toProjectRelativePosix(absPath: string, projectRoot: string): string {
...
export function toMemoryRelativePosix(absPath: string, paths: MemoryPaths): string {
...
export function assertRelativePosix(value: string): string {
